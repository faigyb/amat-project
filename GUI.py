...
class MainWindow(QDialog):
    ...
    def __init__(self, parent=None, is_dl=False):
        ...
        self.label.setFixedSize(1190, 60)
    ...
    def load_image(self):
        ...
        self.label.setStyleSheet("background-color: rgb(50,200, 200);")
        self.label.setText('upload a picture and choose a square area to recognize or tap to take the whole picture')
    ...
    def classify_image(self):
        ...
        self.title=label
        params.label=label
        self.label.setStyleSheet("background-color: rgb(50,100, 200);")

        self.label.setText(f'photo predicted as {label}')
        print(label)
        #self.label.setStyleSheet("background-color: rgb(50,200, 200);")
